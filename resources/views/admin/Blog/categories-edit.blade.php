                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex space-x-2">
                            <button type="button" onclick="setIcon('📝')"
                                class="px-3 py-2 bg-gray-100 hover:bg-gray-200 rounded text-2xl">📝</button>
                            <button type="button" onclick="setIcon('💡')"
                                class="px-3 py-2 bg-gray-100 hover:bg-gray-200 rounded text-2xl">💡</button>
                            <button type="button" onclick="setIcon('📰')"
                                class="px-3 py-2 bg-gray-100 hover:bg-gray-200 rounded text-2xl">📰</button>
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-4 gap-3">
                        <label class="cursor-pointer">
                            <input type="radio" name="color" value="bg-gradient-to-r from-blue-500 to-blue-600"
                                class="hidden peer" {{ old('color') == 'bg-gradient-to-r from-blue-500 to-blue-600' ? 'checked' : '' }}>
                            <div
                                class="bg-gradient-to-r from-blue-500 to-blue-600 h-12 rounded-lg peer-checked:ring-4 peer-checked:ring-blue-300">
                            </div>
                        </label>
                        <label class="cursor-pointer">
                            <input type="radio" name="color" value="bg-gradient-to-r from-purple-500 to-purple-600"
                                class="hidden peer" {{ old('color') == 'bg-gradient-to-r from-purple-500 to-purple-600' ? 'checked' : '' }}>
                            <div
                                class="bg-gradient-to-r from-purple-500 to-purple-600 h-12 rounded-lg peer-checked:ring-4 peer-checked:ring-purple-300">
                            </div>
                        </label>
                        <label class="cursor-pointer">
                            <input type="radio" name="color" value="bg-gradient-to-r from-green-500 to-green-600"
                                class="hidden peer" {{ old('color') == 'bg-gradient-to-r from-green-500 to-green-600' ? 'checked' : '' }}>
                            <div
                                class="bg-gradient-to-r from-green-500 to-green-600 h-12 rounded-lg peer-checked:ring-4 peer-checked:ring-green-300">
                            </div>
                        </label>
                        <label class="cursor-pointer">
                            <input type="radio" name="color" value="bg-gradient-to-r from-orange-500 to-orange-600"
                                class="hidden peer" {{ old('color') == 'bg-gradient-to-r from-orange-500 to-orange-600' ? 'checked' : '' }}>
                            <div
                                class="bg-gradient-to-r from-orange-500 to-orange-600 h-12 rounded-lg peer-checked:ring-4 peer-checked:ring-orange-300">
                            </div>
                        </label>
                        <label class="cursor-pointer">
                            <input type="radio" name="color" value="bg-gradient-to-r from-red-500 to-red-600"
                                class="hidden peer" {{ old('color') == 'bg-gradient-to-r from-red-500 to-red-600' ? 'checked' : '' }}>
                            <div
                                class="bg-gradient-to-r from-red-500 to-red-600 h-12 rounded-lg peer-checked:ring-4 peer-checked:ring-red-300">
                            </div>
                        </label>
                        <label class="cursor-pointer">
                            <input type="radio" name="color" value="bg-gradient-to-r from-pink-500 to-pink-600"
                                class="hidden peer" {{ old('color') == 'bg-gradient-to-r from-pink-500 to-pink-600' ? 'checked' : '' }}>
                            <div
                                class="bg-gradient-to-r from-pink-500 to-pink-600 h-12 rounded-lg peer-checked:ring-4 peer-checked:ring-pink-300">
                            </div>
                        </label>
                        <label class="cursor-pointer">
                            <input type="radio" name="color" value="bg-gradient-to-r from-indigo-500 to-indigo-600"
                                class="hidden peer" {{ old('color') == 'bg-gradient-to-r from-indigo-500 to-indigo-600' ? 'checked' : '' }}>
                            <div
                                class="bg-gradient-to-r from-indigo-500 to-indigo-600 h-12 rounded-lg peer-checked:ring-4 peer-checked:ring-indigo-300">
                            </div>
                        </label>
                        <label class="cursor-pointer">
                            <input type="radio" name="color" value="bg-gradient-to-r from-teal-500 to-teal-600"
                                class="hidden peer" {{ old('color') == 'bg-gradient-to-r from-teal-500 to-teal-600' ? 'checked' : '' }}>
                            <div
                                class="bg-gradient-to-r from-teal-500 to-teal-600 h-12 rounded-lg peer-checked:ring-4 peer-checked:ring-teal-300">
                            </div>
                        </label>
                    </div>
                    @error('color')
