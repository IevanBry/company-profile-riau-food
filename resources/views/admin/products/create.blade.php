...
@section('page-subtitle', 'Buat produk baru untuk kategori tertentu')
            ...
            <div class="p-6 space-y-5">
                ...
                <div>
                    ...
                    <textarea name="description" rows="4" required
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent transition"
                        placeholder="Body shampoo dengan ekstrak mawar yang memberikan aroma elegan dan menyegarkan untuk kulit Anda.">{{ old('description') }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        ...
                        <p class="text-xs text-gray-500 mt-1">Format: JPG, PNG, atau GIF. Maksimal 2MB. Wajib upload gambar produk</p>
                    </div>
                    <!-- Preview Image -->
                    <div id="imagePreview" class="mt-4 hidden">
                        <p class="text-xs text-gray-600 mb-2">Preview Gambar:</p>
                        <div class="relative inline-block">
                            <img id="previewImg" src="" alt="Preview" class="max-w-md w-full rounded-lg shadow-md border-2 border-gray-200">
                            <button type="button" onclick="removeImage()" class="absolute top-2 right-2 bg-red-500 text-white rounded-full p-2 hover:bg-red-600 transition shadow-lg">
