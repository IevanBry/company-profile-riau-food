...
@section('page-title', 'Tambah Lowongan Kerja')
@section('page-subtitle', 'Buat lowongan pekerjaan baru')
                    ...
                    <div class="grid gap-6">
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="4" required placeholder="Jelaskan tentang posisi ini..."
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="grid gap-6">
                        <div>
                            ...
                            <textarea name="requirements" rows="5"
                                ...
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition font-mono text-sm @error('requirements') border-red-500 @enderror">{{ old('requirements') }}</textarea>
                            @error('requirements')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="responsibilities" rows="5"
                                ...
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition font-mono text-sm @error('responsibilities') border-red-500 @enderror">{{ old('responsibilities') }}</textarea>
                ...
                <div class="mb-8">
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="color" name="color" value="{{ old('color', '#F97316') }}"
